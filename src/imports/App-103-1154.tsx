import svgPaths from "./svg-s59u02wzpe";
...
function Paragraph1() {
  return (
    <div className="absolute h-[20px] left-0 top-[84px] w-[277.328px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[139.66px] not-italic text-[14px] text-center text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] translate-x-[-50%] whitespace-pre">25.06.2002 • 23 Jahre</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Geburtsdatum</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-800 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">25.06.2002 (23 Jahre)</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col h-[44px] items-start left-[32px] top-0 w-[162.945px]" data-name="Container">
      <Paragraph2 />
      <Paragraph3 />
    </div>
  );
...
function Heading9() {
  return (
    <div className="absolute h-[30px] left-0 top-0 w-[618.672px]" data-name="Heading 2">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[30px] left-0 not-italic text-[#ec003f] text-[20px] text-nowrap top-0 tracking-[-0.4492px] whitespace-pre">Berufserfahrung</p>
    </div>
  );
}
...
function Paragraph23() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Datenverarbeitung</p>
    </div>
  );
}
...
function Paragraph24() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Erfahrung in der digitalen Datenverarbeitung und -verwaltung</p>
    </div>
  );
}
...
function Paragraph25() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Einzelhandel</p>
    </div>
  );
}
...
function Paragraph26() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Kundenbetreuung und Verkauf im Einzelhandel</p>
    </div>
  );
}
...
function Paragraph27() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Ferienjob</p>
    </div>
  );
}
...
function Paragraph28() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Praktische Erfahrung in der Automobilindustrie</p>
    </div>
  );
}
...
function CvDocument() {
  return (
    <div className="bg-white h-[1252px] overflow-clip relative rounded-[10px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="CVDocument">
      <Container25 />
      <Container45 />
    </div>
  );
