import svgPaths from "./svg-b9b9ikhnt9";
import imgImageAnnVogel from "figma:asset/8f89b2326b9d544219af3cc93658320554fd85d6.png";
...
function Paragraph8() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">C1 - Fließend</p>
    </div>
  );
}
...
export default function App() {
  return (
    <div className="bg-neutral-100 relative size-full" data-name="App">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start pb-0 pt-[32px] px-[122px] relative size-full">
          <CvDocument />
        </div>
      </div>
    </div>
