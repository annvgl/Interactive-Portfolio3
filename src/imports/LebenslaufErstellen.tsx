import svgPaths from "./svg-n22ulcl8lz";
...
function Heading() {
  return (
    <div className="absolute h-[36px] left-0 top-0 w-[277.328px]" data-name="Heading 1">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[36px] left-[138.78px] not-italic text-[#ec003f] text-[24px] text-center text-nowrap top-0 tracking-[0.0703px] translate-x-[-50%] whitespace-pre">Ann Vogel</p>
    </div>
  );
}

function Container1() {
  return <div className="absolute bg-[#ff2056] h-[4px] left-[90.66px] top-[44px] w-[96px]" data-name="Container" />;
}

function Paragraph() {
  return (
    <div className="absolute h-[24px] left-0 top-[64px] w-[277.328px]" data-name="Paragraph">
...
function Container2() {
  return (
    <div className="absolute h-[88px] left-[32px] top-[256px] w-[277.328px]" data-name="Container">
      <Heading />
      <Container1 />
      <Paragraph />
    </div>
...
function Heading2() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 3">
      <Icon />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[27px] left-[28px] not-italic text-[#ec003f] text-[18px] text-nowrap top-[0.5px] tracking-[-0.4395px] whitespace-pre">Kontakt</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Telefon</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">E-Mail</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[104px] items-start left-0 top-[65px] w-[277.328px]" data-name="Container">
      <Container6 />
      <Container8 />
    </div>
  );
...
function Heading4() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
      <Icon3 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[28px] not-italic text-[#ec003f] text-[16px] text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Sprachen</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-800 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Deutsch</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Muttersprache</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-800 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Englisch</p>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">C1</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[214px] items-start left-0 top-[201px] w-[277.328px]" data-name="Container">
      <Heading4 />
      <Container10 />
      <Container13 />
    </div>
...
function Container21() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[285px] items-start left-0 top-[447px] w-[277.328px]" data-name="Container">
      <Heading5 />
      <Container15 />
      <Container20 />
    </div>
...
function Container22() {
  return (
    <div className="absolute h-[732px] left-[32px] top-[376px] w-[277.328px]" data-name="Container">
      <Container4 />
      <Container9 />
      <Container14 />
      <Container21 />
...
function Container23() {
  return (
    <div className="absolute bg-gradient-to-b from-[#fff1f2] h-[1140px] left-0 to-[#ffe4e6] top-0 w-[341.328px]" data-name="Container">
      <Container />
      <Container2 />
      <Container22 />
    </div>
...
function Heading1() {
  return (
    <div className="absolute h-[30px] left-0 top-0 w-[618.672px]" data-name="Heading 2">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[30px] left-0 not-italic text-[#ec003f] text-[20px] text-nowrap top-0 tracking-[-0.4492px] whitespace-pre">Ausbildung</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[113.492px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[113.492px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Mai 2024 - Heute</p>
      </div>
    </div>
  );
}
...
function Paragraph13() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Studium: Interaktionsgestaltung</p>
    </div>
  );
}
...
function Paragraph14() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Vertiefung in UI/UX Design, Prototyping und digitaler Gestaltung</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Abitur</p>
    </div>
  );
}
...
function Paragraph16() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Abschluss der gymnasialen Oberstufe</p>
    </div>
  );
}
...
function Paragraph17() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Auslandsjahr in Irland</p>
    </div>
  );
}
...
function Paragraph18() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Internationale Erfahrung und Sprachkenntnisse</p>
    </div>
  );
}
...
function Paragraph19() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-700 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Mittelstufe</p>
    </div>
  );
}
...
function Heading10() {
  return (
    <div className="absolute h-[30px] left-0 top-0 w-[618.672px]" data-name="Heading 2">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[30px] left-0 not-italic text-[#ec003f] text-[20px] text-nowrap top-0 tracking-[-0.4492px] whitespace-pre">Expertise</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p2d3acea0} id="Vector" stroke="var(--stroke-0, #EC003F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container38() {
  return (
    <div className="bg-rose-100 relative rounded-[10px] shrink-0 size-[48px]" data-name="Container">
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-800 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">UI/UX Design</p>
    </div>
  );
}
...
function Paragraph20() {
  return (
    <div className="h-[80px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 top-[0.5px] tracking-[-0.1504px] w-[184px]">Erstellung von Benutzeroberflächen und Nutzererlebnissen mit Fokus auf Interaktionsgestaltung</p>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="content-stretch flex gap-[12px] h-[108px] items-start relative shrink-0 w-full" data-name="Container">
      <Container38 />
      <Container39 />
    </div>
  );
...
function Container41() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col h-[148px] items-start left-0 pb-0 pt-[20px] px-[20px] rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] top-0 w-[301.336px]" data-name="Container">
      <Container40 />
    </div>
  );
}
...
function Icon6() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p242ac700} id="Vector" stroke="var(--stroke-0, #EC003F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Heading11() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-neutral-800 text-nowrap top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Projektmanagement</p>
    </div>
  );
}
...
function Paragraph21() {
  return (
    <div className="h-[60px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-neutral-600 top-[0.5px] tracking-[-0.1504px] w-[189px]">Leitung und Koordination von Gruppenprojekten mit agilen Methoden</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="basis-0 grow h-[88px] min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[4px] h-[88px] items-start relative w-full">
        <Heading11 />
        <Paragraph21 />
      </div>
    </div>
...
function Container45() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col h-[148px] items-start left-[317.34px] pb-0 pt-[20px] px-[20px] rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] top-0 w-[301.336px]" data-name="Container">
      <Container44 />
    </div>
  );
}
...
function Container47() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[214px] items-start relative shrink-0 w-full" data-name="Container">
      <Container37 />
      <Container46 />
    </div>
  );
...
function Container48() {
  return (
    <div className="absolute bg-neutral-50 box-border content-stretch flex flex-col gap-[40px] h-[1140px] items-start left-[341.33px] pb-0 pt-[32px] px-[32px] top-0 w-[682.672px]" data-name="Container">
      <Container35 />
      <Container47 />
    </div>
  );
...
function CvDocument() {
  return (
    <div className="bg-white h-[1140px] overflow-clip relative rounded-[10px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="CVDocument">
      <Container23 />
      <Container48 />
    </div>
  );
...
function App() {
  return (
    <div className="bg-neutral-100 h-[1204px] relative shrink-0 w-full" data-name="App">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col h-[1204px] items-start pb-0 pt-[32px] px-[122px] relative w-full">
          <CvDocument />
        </div>
      </div>
    </div>
...
export default function LebenslaufErstellen() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Lebenslauf erstellen">
      <App />
    </div>
  );
}